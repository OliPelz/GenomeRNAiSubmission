(function() {
    ...
    as.config(function($routeProvider, $httpProvider) {
        $routeProvider
                .when('/experiments', {templateUrl: 'partials/experiments.html', controller: 'ExperimentCtrl'})
                .when('/datarows', {templateUrl: 'partials/datarows.html', controller: 'NDataRowsCtrl'})
